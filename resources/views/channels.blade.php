        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <a class="mb-1" href="{{route('logout')}}"><button class="btn btn-outline-primary mb-2">خروج</button></a>
                    <div class="card">
                        <div class="row">
                            <div class="col-12">
                                <ul class="list-unstyled chat-contact-list" id="chat-list">
                                    <li class="chat-contact-list-item chat-contact-list-item-title">
                                        <h5 class="text-primary mb-0">کانال ها</h5>
                                    </li>
                                    @if (session('error'))
                                    ...
                                    <li class="chat-contact-list-item">
                                        <a href="{{route('channel page',['id'=>$channel->id])}}" class="d-flex align-items-center">
                                            <div class="flex-shrink-0 avatar">
                                                <img src="{{'https://avindev.com/elahe/public/'.$channel->profile_path}}" alt="Avatar"
                                    ...
                                    @endforeach
                                    @else
                                        <p class="text-center text-muted">هیچ کانالی ندارید</p>
                                    @endif
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="col-12">
                                        <form action="{{route('add channel')}}" method="POST">
                                            <div class="input-group">
                                                <input type="text" name="id" class="form-control" placeholder="نام کاربری کانال را وارد کنید" aria-label="Channel's username">
                                                <button class="btn btn-outline-primary waves-effect" type="submit" id="button-addon2">افزودن کانال</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
