...
class MessageController extends Controller
{
    ...
    private function sendTelegramMessage($channel, $message)
    {
        ...
        switch ($message->type) {
            ...
            case "location":
                list($latitude, $longitude) = explode('/', $message->text);
                // Convert the values to floats
                $latitude = (float) $latitude;
                $longitude = (float) $longitude;
                $params['latitude'] = InputFile::create($latitude);
                $params['longitude'] = InputFile::create($longitude);
                return Telegram::sendLocation($params);
